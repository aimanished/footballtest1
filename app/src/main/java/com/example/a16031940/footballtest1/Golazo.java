...
public class Golazo extends Activity {
    RadioButton rb;
    RadioGroup rg;
    TextView tv, tv1;
    EditText name, jnum;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_golazo);
            ...
            public void onClick(View v) {
                ...
                if (rb.getText().toString().equalsIgnoreCase("home")) {
                    if (name.getText().toString().equals("") && jnum.getText().toString().equals("")) {
                        event = "Home player gets a goal";
                    } else if (name.getText().toString().equals("") && jnum.getText().toString().trim().length() > 0) {
                        event = "Home player number " + jnum.getText().toString() + "gets a goal!";
                    } else if (name.getText().toString().trim().length() > 0 && jnum.getText().toString().equals("")) {
                        event = "Home player," + name.getText().toString() + " , gets a goal!";
                    } else {
                        event = "Home player," + name.getText().toString() + " number" + jnum.getText().toString() + ",gets a goal!";
                    }
                } else {
                    if (name.getText().toString().equals("") && jnum.getText().toString().equals("")) {
                        event = "Away player gets a goal";
                    } else if (name.getText().equals("") && jnum.getText().toString().trim().length() > 0) {
                        event = "Away player number " + jnum.getText().toString() + "gets a goal!";
                    } else if (name.getText().toString().trim().length() > 0 && jnum.getText().equals("")) {
                        event = "Away player," + name.getText().toString() + " , gets a goal!";
                    } else {
                        event = "Away player," + name.getText().toString() + " number" + jnum.getText().toString() + ",gets a goal!";
                    }
                }
                Toast.makeText(Golazo.this, event, Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Golazo.this, Startgame.class);
                intent.putExtra("eventGoals" , event);
                intent.putExtra("golazo" , rb.getText());
